...
//		paddingBottom = ViewUtils.dpToPx(16, getResources());
//		paddingLeft = ViewUtils.dpToPx(16, getResources());
//		paddingRight = ViewUtils.dpToPx(16, getResources());
//		paddingTop = ViewUtils.dpToPx(16, getResources());
        super.minWidth = 80;
        super.minHeight = 36;
...
//			paddingBottom = ViewUtils.dpToPx(padding, getResources());
//			paddingLeft = ViewUtils.dpToPx(padding, getResources());
//			paddingRight = ViewUtils.dpToPx(padding, getResources());
//			paddingTop = ViewUtils.dpToPx(padding, getResources());
//		}else{
...
//		if((textButton.getWidth()+paddingLeft+paddingRight)>ViewUtils.dpToPx(80, getResources()))
