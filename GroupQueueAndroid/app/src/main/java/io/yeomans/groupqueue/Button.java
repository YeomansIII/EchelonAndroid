...
public abstract class Button extends CustomView {
    ...
    protected void setDefaultProperties() {
        // Min size
        setMinimumHeight(ViewUtils.dpToPx(minHeight, getResources()));
        setMinimumWidth(ViewUtils.dpToPx(minWidth, getResources()));
        // Background shape
    ...
    public Bitmap makeCircle() {
        Bitmap output = Bitmap.createBitmap(
                getWidth() - ViewUtils.dpToPx(6, getResources()), getHeight()
                        - ViewUtils.dpToPx(7, getResources()), Config.ARGB_8888);
